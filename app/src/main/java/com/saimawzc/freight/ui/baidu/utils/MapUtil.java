package com.saimawzc.freight.ui.baidu.utils;
...
import static com.saimawzc.freight.ui.baidu.utils.BitmapUtil.bmArrowPoint;
import static com.saimawzc.freight.ui.baidu.utils.BitmapUtil.bmEnd;
import static com.saimawzc.freight.ui.baidu.utils.BitmapUtil.bmStart;
...
public class MapUtil {
     ...
     * @param trackApp
     */
    public void setCenter(BaseApplication trackApp) {
    ...
    public void updateStatus(LatLng currentPoint, boolean showMarker) {
        ...
        if (null != baiduMap.getProjection()) {
            ...
            if (screenPoint.y < 200 || screenPoint.y > BaseApplication.screenHeight - 500
                    || screenPoint.x < 200 || screenPoint.x > BaseApplication.screenWidth - 200
                    || null == mapStatus) {
