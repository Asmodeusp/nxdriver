...
public class TaxationIdentificationFragment extends BaseFragment implements TaxaSysView {
    ...
    @BindView(R.id.imgidpositive) ImageView imgPositive;
    ...
    @BindView(R.id.groupblue) RadioButton  radioCarnoBlue;
    ...
    @BindView(R.id.tvcaradress)TextView tvCarAdress;
    ...
    @OnClick({R.id.chooseidpositive,R.id.bankscan,R.id.chooseidotherside,
    ...
    public void initView() {
        ...
        context.setToolbar(toolbar,"税务认证信息");
        presenter=new TaxaSysPresenter(this,mContext);
        queryDto= (FaceQueryDto) getArguments().getSerializable("data");
    ...
    public String carId() {
        if(facedata==null){
            return  getArguments().getString("carId");
        }else {
