...
import android.widget.TextView;
public class DragTV extends android.support.v7.widget.AppCompatTextView {
    ...
    public listen onTabClickListener;
    public void setOnTabClickListener(listen onItemTabClickListener) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Math.abs(hor)<1&&Math.abs(ver)<1){
                    if(onTabClickListener!=null){
                        onTabClickListener.onItemClick(this);
                    }
                   return false;
                }else {
                    return true;
