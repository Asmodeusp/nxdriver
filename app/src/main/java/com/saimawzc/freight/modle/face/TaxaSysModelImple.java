...
public class TaxaSysModelImple extends BasEModeImple implements TaxaSysModel  {
    ...
    @Override
    public void edit(final TaxaSysView view) {
        view.showLoading();
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, final Response response) throws IOException {
               ...
               final String content=response.body().string();
                view.getContect().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
    ...
    @Override
    public void showCamera(final TaxaSysView view, Context context, final int type) {
    ...
    @Override
    public void getCarType(final TaxaSysView view, final CarTypeListener listener) {
        view.showLoading();
        JSONObject jsonObject=new JSONObject();
        final MediaType JSON= MediaType.parse("application/json; charset=utf-8");
    ...
    @Override
    public void getBrand(final TaxaSysView view, final CarBrandListener listener, String type) {
        view.showLoading();
        JSONObject jsonObject=new JSONObject();
        try {
