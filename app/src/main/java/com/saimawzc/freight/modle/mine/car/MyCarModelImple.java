...
public class MyCarModelImple extends BasEModeImple implements MyCarModel {

    @Override
    public void getCarList(final MyCarView view, final SearchCarListener listener, int type,int page,String carNo) {
        view.showLoading();
        ...
        mineApi.getMyCarList(body).enqueue(new CallBack<MyCarDto>() {
            @Override
