...
public class SmallCarrierModelImple extends BasEModeImple implements SmallCarrierModel {
    ...
    @Override
    public void identification(final SmallCompanyCarrierView view, final BaseListener listener) {
        ...
        try {
            ...
            jsonObject.put("carrierType","3");//承运商类型（1.个人承运商 2.一般纳税人 3.小规模企业）
            ...
            jsonObject.put("roadPermit",view.sringTransport());//身份证反面
    ...
    @Override
    public void reidentification(final SmallCompanyCarrierView view, final BaseListener listener) {
        JSONObject jsonObject=new JSONObject();
        view.showLoading();
        UserInfoDto loginDo= Hawk.get(PreferenceKey.USER_INFO);
        if(loginDo==null){
    ...
    @Override
    public void getIdentificationInfo(final SmallCompanyCarrierView view,
