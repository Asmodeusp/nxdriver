...
public class MsBankAdpater extends BaseAdapter {

    private List<MsBankDto> mDatas=new ArrayList<>();
    private Context mContext;
    private LayoutInflater mInflater;
    public MsBankAdpater(List<MsBankDto> mDatas, Context mContext) {
        this.mDatas = mDatas;
        this.mContext = mContext;
        mInflater = LayoutInflater.from(mContext);
    }

    public void setData(List<MsBankDto> mDatas ) {
        this.mDatas = mDatas;
        notifyDataSetChanged();
    }

    public List<MsBankDto> getData() {
        return mDatas;
    }
    public void addMoreData(List<MsBankDto> newDatas) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if(holder instanceof ViewHolder){
            MsBankDto dto=mDatas.get(position);
            ((ViewHolder) holder).tvNum.setText(dto.getBankName());
