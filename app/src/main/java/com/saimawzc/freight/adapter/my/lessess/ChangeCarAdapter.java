...
public class ChangeCarAdapter extends BaseAdapter {
    ...
    public ChangeCarAdapter(List<SearchCarDto> mDatas, Context mContext) {
        this.mDatas = mDatas;
        this.mContext = mContext;
        mInflater = LayoutInflater.from(mContext);
        activity=(BaseActivity) mContext;
    }
    public ChangeCarAdapter(List<SearchCarDto> mDatas, Context mContext, int type) {
        this.mDatas = mDatas;
        this.mContext = mContext;
        mInflater = LayoutInflater.from(mContext);
        activity=(BaseActivity) mContext;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            View view = mInflater.inflate(R.layout.item_carchange, parent,
                    false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof ViewHolder){
            ...
            if(searchCarDto!=null){
                ...
                ((ViewHolder) holder).tvUser.setText(searchCarDto.getOldUserName());
                ...
                ((ViewHolder) holder).tvReason.setText(searchCarDto.getCheckOpinion());
