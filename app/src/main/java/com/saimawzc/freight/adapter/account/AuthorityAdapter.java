...
public class AuthorityAdapter extends BaseAdapter {
    ...
    public AuthorityAdapter(List<AuthorityDto> mDatas, Context mContext) {
        this.mDatas = mDatas;
    ...
    public void setData(List<AuthorityDto> mDatas ) {
        this.mDatas = mDatas;
    ...
    public void addMoreData(List<AuthorityDto> newDatas) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            View view = mInflater.inflate(R.layout.item_authority, parent,
                    false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if(holder instanceof ViewHolder){
            AuthorityDto dto=mDatas.get(position);
           ((ViewHolder) holder).tvAuthorityName.setText(dto.getCompanyName());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.tvauthorityName) TextView tvAuthorityName;
