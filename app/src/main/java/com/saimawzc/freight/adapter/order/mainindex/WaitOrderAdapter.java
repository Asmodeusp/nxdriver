...
public class WaitOrderAdapter extends BaseAdapter {
    ...
    public WaitOrderAdapter(List<WaitOrderDto.waitOrderData> mDatas, Context mContext) {
        this.mDatas = mDatas;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            View view = mInflater.inflate(R.layout.item_waitorder, parent,
                    false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if(holder instanceof ViewHolder){
            ...
            if(dto.getWaybillType()==1){
                ...
                ((ViewHolder) holder).tvUitl3.setText("重      量：");
